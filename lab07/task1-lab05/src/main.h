...
get_nod_while(int num1, int num2) {//функція, яка знаходить найбільший спільний дільник з циклу while do
	int nod_while = 0;
	while (num1 > 0 && num2 > 0) {
		if (num1 > num2) {
			num1 %= num2;
...
get_nod_for(int num1, int num2) {//функція, яка знаходить найбільший спільний дільник з циклу for
	int nod_for = 0;
	for (; num1 > 0 && num2 > 0;) {
...
get_nod_do(int num1, int num2) {//функція, яка знаходить найбільший спільний дільник з циклу do while
	int nod_do = 0;
	do {
		if (num1 > num2) {
			num1 %= num2;
